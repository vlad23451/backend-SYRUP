...
update_history_description = (
    ...
    "Можно обновить заголовок и описание. "
    "Требует авторизации и права на изменение. "
    "Возвращает обновлённую историю. "
    "Возможные ошибки: история не найдена, ошибка прав, ошибка базы данных."
)

add_history_files_description = (
    "Добавляет файлы к существующим вложениям истории. "
    "Передайте список ID файлов для добавления. "
    "Файлы, которые уже прикреплены, не будут дублироваться. "
    "Требует авторизации и права на изменение. "
    "Возвращает обновлённую историю с новыми вложениями. "
    "Возможные ошибки: история не найдена, ошибка прав, ошибка базы данных."
)

replace_history_files_description = (
    "Полностью заменяет вложения истории. "
    "Передайте список ID файлов, которые должны быть прикреплены к истории. "
    "Файлы, не указанные в списке, будут откреплены. "
    "Пустой список открепляет все файлы. "
    "Требует авторизации и права на изменение. "
    "Возвращает обновлённую историю с новыми вложениями. "
    "Возможные ошибки: история не найдена, ошибка прав, ошибка базы данных."
)
