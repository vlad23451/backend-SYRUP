...
main_router.include_router(private_media)
main_router.include_router(favorites)
main_router.include_router(history_views)
main_router.include_router(user_blocks)
main_router.include_router(pinned_message)
