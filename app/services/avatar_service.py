...
from exceptions.users import UserNotFoundAvatar
...
class AvatarService:
    ...
    async def _delete_old_avatar(self, old_avatar_key: str | None) -> None:
    ...
    async def get_my_avatar_url(self, current_user: User) -> str:
        if not current_user.avatar_key:
            ...
            raise UserNotFoundAvatar("У вас нет аватара")
